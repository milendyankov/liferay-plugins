...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	@Override
	public int compareTo(com.liferay.demo.model.Foo foo) {
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.liferay.demo.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public com.liferay.demo.model.Foo toEscapedModel() {
	...
	@Override
	public com.liferay.demo.model.Foo toUnescapedModel() {
