...
import com.liferay.demo.model.FooClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"simple-sdk-sb-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "simple-sdk-sb-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.liferay.demo.model.impl.FooImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.liferay.demo.NoSuchFooException")) {
			return new com.liferay.demo.NoSuchFooException(throwable.getMessage(),
				throwable.getCause());
		}
