...
import com.liferay.demo.NoSuchFooException;
import com.liferay.demo.model.Foo;
import com.liferay.demo.model.impl.FooImpl;
import com.liferay.demo.model.impl.FooModelImpl;
import com.liferay.demo.service.persistence.FooPersistence;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	@Override
	public Foo updateImpl(com.liferay.demo.model.Foo foo) {
		foo = toUnwrappedModel(foo);
